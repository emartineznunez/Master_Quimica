...
En el siguiente Notebook se muestra el funcionamiento de un programa automético de descubrimiento de reacciones químicas. Concretamente el ejemplo que se muestra se refiere al sistema CH<sub>2</sub>O<sub>2</sub>
